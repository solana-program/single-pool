...
Instead please use this [Report a Vulnerability](https://github.com/solana-program/single-pool/security/advisories/new) link.
...
Only the `spl-single-pool` program is included in the bounty scope, at
[program](https://github.com/solana-program/single-pool/tree/master/program).
